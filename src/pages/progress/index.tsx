        ...
        <div className='page__bd page__bd_spacing'>
            <div className='weui-progress'>
                <div className='weui-progress__bar'>
                    <div className='weui-progress__inner-bar js_progress' style={{width:`${progress === -1 ? '0' : progress}%`}}></div>
                </div>
            ...
            <div className='weui-progress'>
                <div className='weui-progress__bar'>
                    <div className='weui-progress__inner-bar js_progress' style={{width: `${progress === -1 ? '50' : progress}%`}}></div>
                </div>
                <a href='javascript:' className='weui-progress__opr'>
                    <i className='weui-icon-cancel'></i>
                </a>
            ...
            <div className='weui-progress'>
                <div className='weui-progress__bar'>
                    <div className='weui-progress__inner-bar js_progress' style={{width: `${progress === -1 ? '80' : progress}%`}}></div>
                </div>
                <a href='javascript:' className='weui-progress__opr'>
                    <i className='weui-icon-cancel'></i>
                </a>
            ...
            <div className='weui-btn-area'>
                <a
                  href='javascript:'
                  ref={btnRef}
                  className={'weui-btn weui-btn_primary' + `${isLoading ? 'weui-btn_disabled' : ''}`}
                  id='btnUpload'
                  onClick={handleClick}
                >
                  上传
