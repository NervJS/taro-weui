...
export default function () {
  ...
  const hideActionSheet = useCallback(function () {
    setIsShowIOS(false)
    iosMaskfadeOut()
  }, [iosMaskfadeOut])

  const showIOSActionSheet = useCallback(function () {
    setIsShowIOS(true)
    iosMaskfadeIn()
  }, [iosMaskfadeIn])
    ...
    <body>
      <div className='page actionsheet js_show'>
        ...
        <div className='page__bd page__bd_spacing'>
            <a href='javascript:' className='weui-btn weui-btn_default' id='showIOSActionSheet' onClick={showIOSActionSheet}>iOS ActionSheet</a>
            <a
              href='javascript:'
        ...
        <div>
            ...
            ></div>
            <div className={`weui-actionsheet ${isShowIOS ? 'weui-actionsheet_toggle' : ''}`} id='iosActionsheet'>
                <div className='weui-actionsheet__title'>
                    <p className='weui-actionsheet__title-text'>这是一个标题，可以为一行或者两行。</p>
                </div>
                <div className='weui-actionsheet__menu'>
                    <div className='weui-actionsheet__cell'>示例菜单</div>
                    <div className='weui-actionsheet__cell'>示例菜单</div>
                    <div className='weui-actionsheet__cell weui-actionsheet__cell_warn'>负向菜单</div>
                </div>
        ...
        <div className='weui-skin_android' id='androidActionsheet' style={{display: 'none'}} ref={androidRef}>
