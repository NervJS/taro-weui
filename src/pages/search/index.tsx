    ...
    <div className='h5-body'>
      <div className='page button js_show'>
        ...
        <div className='page__bd'>
            <div className={`weui-search-bar ${focus ? 'weui-search-bar_focusing' : ''}`} id='searchBar'>
                <form className='weui-search-bar__form'>
                    <div className='weui-search-bar__box'>
                        ...
                        <input
                          ...
                          onInput={handleInput}
                        />
                        <a href='javascript:' className='weui-icon-clear' id='searchClear' onClick={onClear}></a>
                    </div>
                    {isShowLabel &&
                      <label className='weui-search-bar__label' id='searchText' onClick={handleLabelClick}>
                        <i className='weui-icon-search'></i>
                        <span>搜索</span>
                      </label>
                    }
                </form>
                <a href='javascript:' className='weui-search-bar__cancel-btn' id='searchCancel' onClick={onCancel}>取消</a>
            </div>
            {isShowResult &&
