    ...
    <div className='h5-body'>
      <div className='page top-tips js_show'>
        ...
        <div className='page__bd page__bd_spacing'>
            <a href='javascript:' className='weui-btn weui-btn_default' id='showTopTips' onClick={() => showTopTips()}>显示提示条</a>
            <a href='javascript:' className='weui-btn weui-btn_default' id='hideTopTips' onClick={() => hideTopTips()}>隐藏提示条</a>
        </div>
