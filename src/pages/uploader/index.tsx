...
function usePreview (galleryImg: React.RefObject<HTMLSpanElement>, fadeIn: () => void): [
    ...
    <body>
      <div className='page uploader js_show'>
        <div className='page__hd'>
            ...
            <p className='page__desc'>上传组件，一般配合<a className='link' href='/pages/gallery/index'>组件Gallery</a>来使用。</p>
        </div>
        <div className='page__bd'>
            <div className='weui-gallery' id='gallery' ref={gallery} onClick={galleryFadeOut}>
                <span className='weui-gallery__img' id='galleryImg' ref={galleryImg}></span>
                        ...
                        <div className='weui-uploader'>
                            ...
                            <div className='weui-uploader__bd'>
                                <ul className='weui-uploader__files' id='uploaderFiles'>
                                    <li className='weui-uploader__file' style={{'backgroundImage': `url(${Pic})`}} ref={item1} onClick={onItem1Click}></li>
                                    <li className='weui-uploader__file' style={{'backgroundImage': `url(${Pic})`}} ref={item2} onClick={onItem2Click}></li>
                                    <li className='weui-uploader__file' style={{'backgroundImage': `url(${Pic})`}} ref={item3} onClick={onItem3Click}></li>
                                    <li className='weui-uploader__file weui-uploader__file_status' style={{'backgroundImage': `url(${Pic})`}} ref={item4} onClick={onItem4Click}>
                                        <div className='weui-uploader__file-content'>
                                            <i className='weui-icon-warn'></i>
                                        </div>
                                    </li>
                                    <li className='weui-uploader__file weui-uploader__file_status' style={{'backgroundImage': `url(${Pic})`}} ref={item5} onClick={onItem5Click}>
                                        <div className='weui-uploader__file-content'>50%</div>
                                    </li>
                                </ul>
                                <div className='weui-uploader__input-box'>
                                    <div id='uploaderInput' className='weui-uploader__input' onClick={hanldeUpload} />
                                </div>
                            </div>
                        </div>
                    </div>
