        ...
        <div className='page__bd'>
            <div className='weui-form-preview'>
                ...
                <div className='weui-form-preview__bd'>
                    ...
                    <div className='weui-form-preview__item'>
                        <label className='weui-form-preview__label'>标题标题</label>
                        <span className='weui-form-preview__value'>很长很长的名字很长很长的名字很长很长的名字很长很长的名字很长很长的名字</span>
                    </div>
                </div>
                <div className='weui-form-preview__ft'>
                    <a className='weui-form-preview__btn weui-form-preview__btn_primary' href='javascript:'>操作</a>
                </div>
            </div>
            <br />
            <div className='weui-form-preview'>
                ...
                <div className='weui-form-preview__ft'>
                    <a className='weui-form-preview__btn weui-form-preview__btn_default' href='javascript:'>辅助操作</a>
                    <a className='weui-form-preview__btn weui-form-preview__btn_primary' href='javascript:'>操作</a>
                </div>
            </div>
        </div>
