        ...
        <div className='page__bd' style={{height: '100%'}}>
            <div className='weui-tab'>
                ...
                <div className='weui-tabbar'>
                    <div
                      className={`weui-tabbar__item ${active === 0 ? 'weui-bar__item_on' : ''}`}
                    ...
                    <div
                      className={`weui-tabbar__item ${active === 1 ? 'weui-bar__item_on' : ''}`}
                    ...
                    <div
                      className={`weui-tabbar__item ${active === 2 ? 'weui-bar__item_on' : ''}`}
                    ...
                    <div
                      className={`weui-tabbar__item ${active === 3 ? 'weui-bar__item_on' : ''}`}
