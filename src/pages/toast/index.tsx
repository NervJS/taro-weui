...
function useOnClick (): [React.MutableRefObject<HTMLDivElement | null>, () => void] {
    ...
    <div className='h5-body'>
      <div className='page toast js_show'>
        ...
        <div className='page__bd page__bd_spacing'>
            <a href='javascript:' className='weui-btn weui-btn_default' id='showToast' onClick={onToastClick}>成功提示</a>
            <a href='javascript:' className='weui-btn weui-btn_default' id='showWarnToast' onClick={onWarnToast}>失败提示</a>
            <a href='javascript:' className='weui-btn weui-btn_default' id='showTextMoreToast' onClick={onTextMoreToast}>长文案提示</a>
            <a href='javascript:' className='weui-btn weui-btn_default' id='showLoadingToast' onClick={onLoadingToast}>加载中提示</a>
            <a href='javascript:' className='weui-btn weui-btn_default' id='showTextToast' onClick={onTextToast}>文字提示</a>
        </div>
