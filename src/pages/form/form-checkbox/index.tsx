      ...
      <div className='page form_checkbox js_show'>
        <div className='weui-form'>
              ...
              <div className='weui-cells weui-cells_checkbox'>
                  <label className='weui-cell weui-cell_active weui-check__label' htmlFor='s11'>
                      <div className='weui-cell__hd'>
                          <input type='checkbox' className='weui-check' name='checkbox1' id='s11' checked />
                  ...
                  <a href='javascript:' className='weui-cell weui-cell_active weui-cell_link'>
          ...
          <div className='weui-form__opr-area'>
            <a className='weui-btn weui-btn_primary' href='javascript:' id='showTooltips' onClick={showTooltips}>下一步</a>
          </div>
