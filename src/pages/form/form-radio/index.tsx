      ...
      <div className='page js_show'>
        <div className='weui-form'>
            ...
            <div className='weui-cells__group weui-cells__group_form'>
              <RadioGroup className='weui-cells weui-cells_radio'>
                  ...
                  <label className='weui-cell weui-cell_active weui-check__label' htmlFor='x12'>
                      ...
                      <div className='weui-cell__ft'>
                          <input type='radio' name='radio1' className='weui-check' id='x12' checked />
                          <span className='weui-icon-checked'></span>
                      </div>
                  </label>
          ...
          <div className='weui-form__opr-area'>
            <a className='weui-btn weui-btn_primary' href='javascript:' id='showTooltips' onClick={showTooltips}>确定</a>
          </div>
        </div>
