      ...
      <div className='page js_show'>
        <div className='weui-form'>
          <div className='weui-form__text-area'>
            ...
            <div className='weui-form__desc'>展示表单页面的信息结构样式, 分别由头部区域/控件区域/提示区域/操作区域和底部信息区域组成。</div>
          </div>
              ...
              <div className='weui-cells weui-cells_form'>
                <div className='weui-cell weui-cell_active'>
                  ...
                  <div className='weui-cell__bd'>
                      <input className='weui-input' placeholder='填写本人微信号' ref={input} onInput={handleInput} />
                  </div>
                </div>
                <div className='weui-cell weui-cell_active'>
                  <div className='weui-cell__hd'><label className='weui-label'>昵称</label></div>
                  <div className='weui-cell__bd'>
                      <input className='weui-input' placeholder='填写本人微信号的昵称' />
                  </div>
                </div>
                <div className='weui-cell weui-cell_active'>
                  <div className='weui-cell__hd'><label className='weui-label'>联系电话</label></div>
                  <div className='weui-cell__bd'>
                      <input className='weui-input' placeholder='填写绑定的电话号码' type='number' pattern='[0-9]*' />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='weui-form__opr-area'>
            <a className={`weui-btn weui-btn_primary ${isDisabled ? 'weui-btn_disabled' : ''}`} href='javascript:' id='showTooltips' ref={showTooltips} onClick={handleClick}>确定</a>
          </div>
          <div className='weui-form__tips-area'>
            <p className='weui-form__tips'>
              表单页提示，居中对齐
