      ...
      <div className='page js_show'>
        <div className='weui-form'>
          <div className='weui-form__text-area'>
            ...
            <div className='weui-form__desc'>可体验表单输入的反馈状态。显示报错信息有两种类型，一种是超过1个输入项的时候，用置顶tipsbar报错信息，告知错误原因，页面聚焦到对应的报错区域，内容标红色，另一种是在当前输入项位置报错，适用于只有1个输入项的时候，用户焦点主要是输入区域。</div>
          </div>
          <div className='weui-form__control-area'>
            ...
            <div className='weui-cells__group weui-cells__group_form'>
              ...
              <div id='js_current_tips' style={{display: isShowCurrentTips ? 'block' : 'none'}} className='weui-cells__tips weui-cells__tips_warn'>最多支持8位数</div>
            </div>
            <div className='weui-cells__group weui-cells__group_form'>
              ...
              <div className='weui-cells weui-cells_form'>
                <div className='weui-cell weui-cell_active weui-cell_readonly'>
                  ...
                  <div className='weui-cell__bd'>
                      <input className='weui-input' placeholder='请输入EMail' value='1234567' readOnly />
                  </div>
                </div>
