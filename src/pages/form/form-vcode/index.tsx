        ...
        <div className='weui-form'>
          ...
          <div className='weui-form__control-area'>
            <div className='weui-cells__group weui-cells__group_form'>
              <div className='weui-cells weui-cells_form'>
                  <div className='weui-cell weui-cell_active'>
                      ...
                      <div className='weui-cell__bd'>
                          <input className='weui-input' type='number' pattern='[0-9]*' placeholder='请输入手机号' value='12345678907' />
                      </div>
                      <div className='weui-cell__ft'>
                        <a className='weui-btn_reset weui-btn_icon'>
                          <i id='showIOSDialog1' className='weui-icon-info-circle' onClick={onShowIOSDialog1}></i>
                        </a>
                      </div>
                  </div>
              ...
              <div className='weui-cells__tips'><a className='weui-link' href='javascript:'>收不到验证码</a></div>
            </div>
          </div>
          <CheckboxGroup className='weui-form__tips-area' onChange={() => setIsAgree(!isAgree)} >
            <label id='weuiAgree' htmlFor='weuiAgreeCheckbox' className='weui-agree' ref={weuiAgree} >
              <input id='weuiAgreeCheckbox' type='checkbox' className='weui-agree__checkbox' ref={agreeCheckbox} checked={isAgree} />
        ...
        <div id='dialogs'>
            <div className='js_dialog' id='iosDialog1' style={{display: 'none'}} ref={iosDialog1}>
                ...
                <div
                  ...
                  className={`weui-half-screen-dialog ${isShowDialog ? 'weui-half-screen-dialog_show': ''}`}
                  ref={halfScreenDialog}
                >
                    <div className='weui-half-screen-dialog__hd'>
                      <div className='weui-half-screen-dialog__hd__side'>
                          <div id='dialogClose' className='weui-icon-btn' onClick={onDialogsClose}>
                            关闭
